...
const ToggleButtonGroup = () => {
  return (
    <>
      <div class="mx-auto grid w-11/12 lg:w-10/12 md:px-5 grid-cols-6 md:grid-cols-10 gap-x-3 lg:gap-x-5 gap-y-4 text-base sm:text-lg md:text-xl justify-center font-bold ">
        <button
          x-on:click="all = true;minuman = false;roti=false; pedes_cyin=false;hot_oppa=false"
          class=" bg-gray-button rounded-3xl text-purple-main col-span-2 hover:scale-110 hover:shadow-lg"
        ...
        <button
          ...
          class=" py-3 md:py-4 lg:py-5 bg-gray-button rounded-3xl text-purple-main flex justify-between flex-col items-center col-span-2 hover:scale-110 hover:shadow-lg"
        ...
        <button
          ...
          class=" py-3 md:py-4 lg:py-5 bg-gray-button rounded-3xl text-purple-main flex justify-between flex-col items-center col-start-2 md:col-start-7 col-span-2 hover:scale-110 hover:shadow-lg"
        ...
        <button
          ...
          class=" py-3 md:py-4 lg:py-5 bg-gray-button rounded-3xl text-purple-main flex justify-between flex-col items-center col-span-2 md:col-start-9 hover:scale-110 hover:shadow-lg"
